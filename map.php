...
session_start();
  ...
  <body style="margin:0px; padding:0px;" onload="initMap()">
    <div>
         <label for="raddressInput" class="search">Search location:</label>
         <input type="text" id="addressInput" class="search" size="25"/>
        ...
        <input type="button" class="submit" id="searchButton" value="Search"/>
    </div>
